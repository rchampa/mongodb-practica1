...
libro = { "tipo": "libro",
 ...
 "editorial": "Anaya",
 "Autor": ["Pepe Caballero", "Isabel Sanz","Timoteo Marino", "Camilo Jose Cela"],
"capitulos": [ {"capitulo":1, "titulo": "Primeros pasos en Java", "longitud": 20 },
 {"capitulo":2, "titulo":"Bucles", "longitud": 25 } ]
}
CD = { "tipo": "CD",
 "Artista":"Los piratas",
 "Titulo": "Recuerdos",
 "canciones": [ {"cancion":1, "titulo":"Adios mi barco", "longitud": "3:20" },
...
"Titulo": "Recuerdos",
"canciones": [{"cancion":1,"titulo":"Adios mi barco","longitud": "3:20"},
{"cancion":3,"titulo":"Pajaritos","longitud": "4:15" }]}
...
{"cancion":3,"titulo":"Pajaritos","longitud": "4:15" },
{"cancion":4,"titulo":"Pajaritos4","longitud": "44:15" }
]}

lista= [libro, CD, CD2, CD3, DVD, DVD2,DVD3, DVD4];
...
//Ejercicio 6
db.media.find({"tipo" : "DVD", $or:[{"estreno":"1999"}, {"Titulo" : "Recuerdos"}]})
...
//Ejercicio 8
db.media.find ({"tipo" : "DVD" , "estreno" : { "$mod" : [ 2, 0 ] } } , { "actores" : 0})

//Ejercicio 9
db.media.find({"tipo" : "DVD" ,"estreno" : {"$mod" : [2,1]}}, {"actores" : 0}) // [divisor, resto]

//Ejercicio 10
db.media.find({ "canciones": {"$exists": true}, "canciones":{"$size": 2 } } )

//Ejercicio 11
db.media.find({"actores" : {"$ne" : null}}) 

//Ejercicio 12
db.media.find({ "actores": {"$exists": false} } )
...
//Ejercicio 16
db.media.find ({"tipo" : "DVD" , "estreno" : { "$lt" : 1995 } })

//Ejercicio 17
db.media.find({"Artista" : /piratas/i })

//Ejercicio 18
db.media.find({"Artista" : /piratas/i , "Titulo": {"$exists": true}})
